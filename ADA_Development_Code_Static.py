...
os.chdir('/Users/arvind/Documents/Work/Psychometrics/ADA/')
...
# query = "SELECT q.qcode, \
# concat(q.question,'  (A)',q.optiona,'  (B)',q.optionb,'  (C)',q.optionc,'  (D)',q.optiond) \
# as Question, q.correct_answer as Ans, q.skill as Topic, qp.difficulty as DI, qp.p_thetha \
# FROM educatio_educat.questions q \
# left join educatio_educat.assetD_questionParameters qp \
# on q.qcode = qp.qcode \
...
# and q.optiona is not null \
# and q.optionb is not null \
# and q.optionc is not null \
# and q.optiond is not null \
# and qp.difficulty is not null \
# "
